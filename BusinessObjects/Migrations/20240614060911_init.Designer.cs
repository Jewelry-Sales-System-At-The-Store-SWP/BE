            ...
            modelBuilder.Entity("BusinessObjects.Models.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BillId = "1",
                            CustomerId = "1",
                            SaleDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3982), new TimeSpan(0, 7, 0, 0, 0)),
                            TotalAmount = 500.0,
                            UserId = "1"
                        },
                        new
                        {
                            BillId = "2",
                            CustomerId = "2",
                            SaleDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3984), new TimeSpan(0, 7, 0, 0, 0)),
                            TotalAmount = 1200.0,
                            UserId = "2"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.GoldPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuyPrice = 1000f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4060),
                            SellPrice = 1200f,
                            Type = "9999"
                        },
                        new
                        {
                            ...
                            BuyPrice = 1200f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4061),
                            SellPrice = 1400f,
                            Type = "SCJ"
                        },
                        new
                        {
                            ...
                            BuyPrice = 1400f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4063),
                            SellPrice = 1600f,
                            Type = "18k"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DiscountRate = 1.0,
                            EndDate = new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3950), new TimeSpan(0, 7, 0, 0, 0)),
                            StartDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3921), new TimeSpan(0, 7, 0, 0, 0)),
                            Type = "Giam gia"
                        },
                        new
                        {
                            ...
                            DiscountRate = 2.0,
                            EndDate = new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3958), new TimeSpan(0, 7, 0, 0, 0)),
                            StartDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3957), new TimeSpan(0, 7, 0, 0, 0)),
                            Type = "Giam gia"
                        },
                        new
                        {
                            ...
                            DiscountRate = 3.0,
                            EndDate = new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3961), new TimeSpan(0, 7, 0, 0, 0)),
                            StartDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3960), new TimeSpan(0, 7, 0, 0, 0)),
                            Type = "Giam gia"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObjects.Models.Purchase", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBuyBack = 0,
                            JewelryId = "1",
                            PurchaseDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4082), new TimeSpan(0, 7, 0, 0, 0)),
                            PurchasePrice = 500.0,
                            UserId = "1"
                        },
                        new
                        {
                            ...
                            IsBuyBack = 1,
                            JewelryId = "2",
                            PurchaseDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4084), new TimeSpan(0, 7, 0, 0, 0)),
                            PurchasePrice = 300.0,
                            UserId = "1"
                        },
                        new
                        {
                            ...
                            IsBuyBack = 0,
                            JewelryId = "3",
                            PurchaseDate = new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4086), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("BusinessObjects.Models.StonePrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BuyPrice = 300f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4038),
                            SellPrice = 400f,
                            Type = "Ruby"
                        },
                        new
                        {
                            ...
                            BuyPrice = 400f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4040),
                            SellPrice = 500f,
                            Type = "Sapphire"
                        },
                        new
                        {
                            ...
                            BuyPrice = 500f,
                            City = "Ha Noi",
                            LastUpdated = new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4041),
                            SellPrice = 600f,
                            Type = "Emerald"
                        });
                });

    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 1000f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4060), 1200f, "9999" },
                    { "2", 1200f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4061), 1400f, "SCJ" },
                    { "3", 1400f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4063), 1600f, "18k" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "Giam gia 10%", 1.0, new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3950), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3921), new TimeSpan(0, 7, 0, 0, 0)), "Giam gia" },
                    { "2", null, "Giam gia 20%", 2.0, new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3958), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3957), new TimeSpan(0, 7, 0, 0, 0)), "Giam gia" },
                    { "3", null, "Giam gia 30%", 3.0, new DateTimeOffset(new DateTime(2024, 6, 24, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3961), new TimeSpan(0, 7, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3960), new TimeSpan(0, 7, 0, 0, 0)), "Giam gia" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 300f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4038), 400f, "Ruby" },
                    { "2", 400f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4040), 500f, "Sapphire" },
                    { "3", 500f, "Ha Noi", new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Local).AddTicks(4041), 600f, "Emerald" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, "1", new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3982), new TimeSpan(0, 7, 0, 0, 0)), 500.0, "1" },
                    { "2", null, "2", new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(3984), new TimeSpan(0, 7, 0, 0, 0)), 1200.0, "2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", 0, "1", new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4082), new TimeSpan(0, 7, 0, 0, 0)), 500.0, "1" },
                    { "2", "2", 1, "2", new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4084), new TimeSpan(0, 7, 0, 0, 0)), 300.0, "1" },
                    { "3", "2", 0, "3", new DateTimeOffset(new DateTime(2024, 6, 14, 13, 9, 11, 136, DateTimeKind.Unspecified).AddTicks(4086), new TimeSpan(0, 7, 0, 0, 0)), 1000.0, "1" }
                });
